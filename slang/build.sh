...
# https://www.jedsoft.org/releases/slang/old/slang-2.2.3.tar.gz
source[0]=https://www.jedsoft.org/releases/${topdir}/old/${topdir}-${version}.tar.gz
...
install()
{
    ...
    doc COPYING NEWS README UPGRADE.txt
}
